...
- 2026-09-18 Phase 8 � Card/Lootbox Campaign Meta System. Scaffolded SQLModel backend with User, CardTemplate, and UserInventory tables. Added FastAPI /inventory and /store/buy_pack endpoints with RNG drop weights (70% Common, 25% Rare, 5% Epic). Created EconomyManager Autoload in Godot to manage HTTP requests and VC balance. Built CampaignMenu, StoreUI, and PackOpeningUI with 8-bit visual sequence using Tweens and CPUParticles2D. Headless test passed.
